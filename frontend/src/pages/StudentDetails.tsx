...
import { ArrowLeft, Trophy, BookOpen, Mic, Brain, Target, AlertTriangle } from "lucide-react";
    ...
    <div className="space-y-6 max-w-5xl mx-auto pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-card p-6 rounded-xl border shadow-sm">
        <div className="flex items-center gap-4">
          <Button variant="outline" size="icon" onClick={() => navigate("/admin")} className="rounded-full">
        ...
        <Card className="border-primary/20 bg-primary/5 shadow-sm">
           ...
           <CardContent className="space-y-4">
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">
                Alice shows strong logical reasoning but struggles with complex CSS layouts. Recommendation: Assign "Advanced Layouts" module.
              </p>
           </CardContent>
        </Card>
      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
               {mockStudent.interviews.map((iv, i) => (
                 <div key={i} className="flex items-center justify-between p-4 rounded-xl border hover:bg-muted/30 transition-all cursor-pointer">
